// control bar
const controlLeftBtn = document.querySelector('.sign__control__bar .range-left');
const controlRightBtn = document.querySelector('.sign__control__bar .range-right');
const controlBar = document.querySelector('.sign__control__bar .bar');
console.log(controlBar);

controlRightBtn.addEventListener("click",()=>{
    controlBar.valueAsNumber += 10;
    console.log(controlBar.value);
});
...
((function(){
    var canvas = $("#canvas");
    var div = canvas.parent(".sign__canvas");
    // 캔버스의 오브젝트를 가져옵니다.
    ...
    function draw(e){
        function getPosition(){
            console.log(e);
            return {
                // X: e.offsetX - canvas[0].offsetLeft,
                // Y: e.offsetY - canvas[0].offsetTop
                X: e.offsetX,
                Y: e.offsetY
            }
        }
